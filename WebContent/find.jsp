...
<script type="text/javascript">
	...
	function getFriend(findID, userProfile){
		$('#friendResult').html('<thead>' +
				...
				'<h3>' + findID + '</h3><a href="chat.jsp?toID=' + encodeURIComponent(findID) + '"class="btn btn-primary" style="margin:5px;">'+ '메시지 보내기</a>' +
				'<a href="friends?toID=' + encodeURIComponent(findID) + '"class="btn btn-primary" style="margin:5px;">'+ '친구추가</a></td>' +
				'</tr>' +
			    '</tbody>');
	}
	function failFriend() {
